...
{
    /// <inheritdoc />
    public partial class AddStudyGroupResourcesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "StudyGroupResources",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyGroupResources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudyGroupResources_AspNetUsers_UploadedByUserId",
                        column: x => x.UploadedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudyGroupResources_StudyGroups_StudyGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyGroupResources_StudyGroupId",
                table: "StudyGroupResources",
                column: "StudyGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyGroupResources_UploadedByUserId",
                table: "StudyGroupResources",
