    ...
    public partial class AddStudyGroupTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaximumNumbers = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyGroups_StudyGroupCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "StudyGroupCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyGroups_CategoryId",
                table: "StudyGroups",
                column: "CategoryId");
        }
